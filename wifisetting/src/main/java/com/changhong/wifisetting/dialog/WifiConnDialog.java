...
import com.changhong.wifisetting.utils.WifiConnectUtils;
...
public class WifiConnDialog extends Dialog {
    ...
    public WifiConnDialog(Context context, int theme, ListView mListView,
        ...
        this.txtWifidesc = (TextView) mListView.findViewById(R.id.txt_wifi_desc);
...
//                  Log.i("info",txtWifidesc.getText()+"!!!!!!!!!!!!!");
//                  txtWifidesc.setText("连接中...");
...
//				return isConnect;
    ...
    private void initView() {
        txtWifiName = (TextView) findViewById(R.id.txt_wifi_name1);
        ...
        cbxShowPass = (CheckBox) findViewById(R.id.show_pass);
        txtBtnCancel = (Button) findViewById(R.id.txt_btn_cancel);
        txtBtnConn = (Button) findViewById(R.id.txt_btn_connect);
